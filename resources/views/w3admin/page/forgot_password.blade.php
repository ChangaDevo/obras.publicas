	...
	<div class="login-form">
		...
		<form action="{{ url('index')}}">
			...
			<div class="form-row d-flex justify-content-between mt-4 mb-2">
				...
				<div class="mb-4">
					<a href="{{ url('page-forgot-password')}}" class="btn-link text-primary">Need help?</a>
				</div>
			</div>
			...
			<p class="text-center">Not registered?  
				<a class="btn-link text-primary" href="{{ url('registration')}}">Register</a>
			</p>
		</form>
	</div>
</div>
<div class="col-xl-6 col-lg-6">
	<div class="pages-left h-100">
		...
		<div class="login-media text-center">
			<img src="{{ asset('images/login-1.png')}}" class="w-50" alt="">
		</div>
	</div>
</div>
@endsection