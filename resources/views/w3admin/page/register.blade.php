	...
	<div class="login-form">
		...
		<form action="{{ url('index')}}">
			...
			<div class="mb-4 position-relative">
				...
				<input type="password"id="dz-password" class="form-control form-control" value="Password">
			...
			<div class="text-center mb-4">
				<button type="submit" class="btn btn-primary light btn-block">Sign Up</button>
			</div>
			...
			<p class="text-center">Not registered?  
				<a class="btn-link text-primary" href="{{ url('index')}}">Register</a>
			</p>
		</form>
	</div>
</div>
