				...
				<div class="card-body py-0">
				   <div class="row gx-0">
						...
						<div class="col-xl-2 col-xxl-3">
							<div class="email-left-box dz-scroll ps-0" id="email-left">
								<div class="p-0">
						...
						<div class="col-lg-10 col-xxl-9">
							<div class="email-right-box">
								...
								<div class="row">
									<div class="col-12">
										<div class="right-box-padding p-3">
											<div class="read-wapper dz-scroll" id="read-content">
												<div class="read-content">
													<div class="media pt-3 d-sm-flex d-block justify-content-between">
														...
														<div class="clearfix mb-3">
															<a href="javascript:void(0);" class="btn btn-primary light light px-3 my-1 light me-2"><i class="fa fa-reply"></i> </a>
															<a href="javascript:void(0);" class="btn btn-primary light light px-3 my-1 light me-2"><i class="fas fa-arrow-right"></i> </a>
															<a href="javascript:void(0);" class="btn btn-primary light light px-3 my-1 light me-2"><i class="fa fa-trash"></i></a>
														</div>
													</div>
													<hr>
												...
												<div class="text-end">
													<button class="btn btn-primary light light " type="button">Send</button>
												</div>
											</div>
										</div>
									</div>
