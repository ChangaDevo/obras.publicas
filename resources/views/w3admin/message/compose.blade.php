					...
					<div class="row gx-0">
						...
						<div class="col-xl-2 col-xxl-3 col-lg-3">
							<div class="email-left-box dz-scroll pt-3 ps-0" id="email-left">
								<div class="p-0">
									<a href="{{ url('email-compose')}}" class="btn text-white btn-block"><i class="fa-solid fa-plus me-2"></i>Compose Email</a>
								</div>
								<div class="mail-list rounded ">
									<a href="{{ url('email-inbox')}}" class="list-group-item active"><i class="fa-regular fa-envelope align-middle"></i>Inbox <span class="badge badge-purple badge-sm float-end rounded">2</span> </a>
								...
								<div class="mail-list rounded overflow-hidden mt-4">
									...
									<a href="{{ url('email-inbox')}}" class="list-group-item change">Work </a>
									<a href="{{ url('email-inbox')}}" class="list-group-item change">Private </a>
									<a href="{{ url('email-inbox')}}" class="list-group-item change">Support </a>
									<a href="{{ url('email-inbox')}}" class="list-group-item change">Social </a>
								</div>
							</div>
						</div>
						<!-- /column -->
							...
							<div class="email-right-box ms-0 ">
								<div class="compose-wrapper mt-3 " id="compose-content">
									...
									<div class="text-start mt-4 mb-3">
										<button class="btn btn-primary light light btn-sl-sm me-2" type="button"><span class="me-2"><i class="fa fa-paper-plane"></i></span>Send</button>
