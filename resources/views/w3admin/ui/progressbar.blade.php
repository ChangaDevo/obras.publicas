													...
													<div class="tab-pane fade show active" id="DefaultProgressr" role="tabpanel" aria-labelledby="home-tab">
														<div class="card-body pt-0">
															<div class="progress mb-4">
																<div class="progress-bar linear" style="width: 70%; height:12px;" role="progressbar">
																	<span class="sr-only">60% Complete</span>
																</div>
															</div>
															<h6 class="mb-2 subtitle">Default progress bar with border style</h6>
											...
											<div class="card dz-card" id="striped-progress">
												...
												<div class="tab-content" id="myTabContent1">
													<div class="tab-pane fade show active" id="StripedProgress" role="tabpanel" aria-labelledby="home-tab1">
														<div class="card-body pt-0">
															<div class="progress">
																<div class="progress-bar bg-info progress-bar-striped" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%; height:12px;" role="progressbar">
											...
											<div class="card dz-card" id="colored-progress">
												...
												<div class="tab-content" id="myTabContent3">
													<div class="tab-pane fade show active" id="ColoredProgress" role="tabpanel" aria-labelledby="home-tab3">
														<div class="card-body pt-0">
															<div class="progress-box border-progress tbl-progress-box mt-3">
																<div class="progress">
																	<div class="progress-bar bg-danger-light" style="width:60%; height:12px; border-radius:8px;" role="progressbar"></div>
																</div>
															</div>
