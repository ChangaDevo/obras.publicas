													...
													<div class="tab-pane fade show active" id="CustomStyle" role="tabpanel" aria-labelledby="home-tab11">
														<div class="card-body pt-0">
															<div class="row">
																...
																<div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
																	<div class="dropdown custom-dropdown">
																		<button type="button" class="btn btn-sm btn-primary light d-flex align-items-center" data-bs-toggle="dropdown">
																...
																<div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
																	<div class="dropdown custom-dropdown">
																		<button type="button" class="btn btn-sm btn-primary light flex-wrap" data-bs-toggle="dropdown">
