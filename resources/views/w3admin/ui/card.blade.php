...
<div class="container-fluid">
												...
												<div class="tab-content" id="myTabContent-4">
													<div class="tab-pane fade show active" id="TitleTreatment" role="tabpanel" aria-labelledby="home-tab-4">
														<div class="card-body pt-0 custom-tab-1">
															...
															<p class="card-text">With supporting text below as a natural lead-in to additional content.</p><a href="javascript:void(0);" class="btn btn-primary light btn-card">Go somewhere</a>
														</div>
													</div>
		...
		&lt;/div&gt;    
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white" id="primary-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-5">
													<div class="tab-pane fade show active" id="Primarycard" role="tabpanel" aria-labelledby="home-tab-5">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="btn btn-primary light btn-card">Go
																somewhere</a>
														</div>
		...
		&lt;/div&gt;
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white " id="secondary-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-6">
													<div class="tab-pane fade show active" id="Secondarycard" role="tabpanel" aria-labelledby="home-tab-6">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="btn btn-secondary light btn-card">Go
																somewhere</a>
														</div>
														<div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
														</div>
		...
		&lt;/div&gt;</code></pre>
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white" id="success-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-7">
													<div class="tab-pane fade show active" id="Successcard" role="tabpanel" aria-labelledby="home-tab-7">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="btn btn-success light btn-card">Go
																somewhere</a>
														</div>
														<div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
														</div>
		...
		&lt;/div&gt;</code></pre>
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white" id="danger-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-8">
													<div class="tab-pane fade show active" id="Dangercard" role="tabpanel" aria-labelledby="home-tab-8">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class=" btn btn-danger light btn-card">Go
																somewhere</a>
														</div>
														<div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
														</div>
		...
		&lt;/div&gt; </code></pre>
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white " id="warning-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-9">
													<div class="tab-pane fade show active" id="Warningcard" role="tabpanel" aria-labelledby="home-tab-9">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="btn btn-warning light btn-card">Go
																somewhere</a>
														</div>
														<div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
														</div>
			...
			&lt;/div&gt;</code></pre>
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white" id="info-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-10">
													<div class="tab-pane fade show active" id="Infocard" role="tabpanel" aria-labelledby="home-tab-10">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="btn btn-info light btn-card">Go
																somewhere</a>
														</div>
											...
											<div class="card dz-card" id="light-card">
												...
												<div class="tab-content" id="myTabContent-11">
													<div class="tab-pane fade show active" id="Lightcard" role="tabpanel" aria-labelledby="home-tab-11">
														<div class="card-body pt-0 mb-0">
															<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="btn btn-light btn-card">Go
																somewhere</a>
														</div>
		...
		&lt;/div&gt;</code></pre>
										...
										<!-- Column  -->
										<div class="col-xl-12">
											<div class="card dz-card text-white" id="dark-card">
												<div class="card-header flex-wrap">
												...
												<div class="tab-content" id="myTabContent-12">
													<div class="tab-pane fade show active" id="Darkcard" role="tabpanel" aria-labelledby="home-tab-12">
														<div class="card-body pt-0 mb-0">
															...
															<a href="javascript:void(0);" class="btn btn-dark light  btn-card">Go
																somewhere</a>
														</div>
														<div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
														</div>
