								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="bootstrap-modal">
											...
											<!-- Button trigger modal -->
											<button type="button" class="btn btn-primary light mb-2" data-bs-toggle="modal" data-bs-target="#exampleModalLong">Long content Modal</button>
											<!-- Modal -->
											
											<!-- Button trigger modal -->
											<button type="button" class="btn btn-primary light mb-2" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Modal centered</button>
											<!-- Modal -->
											

											<!-- Button trigger modal -->
											<button type="button" class="btn btn-primary light mb-2" data-bs-toggle="modal" data-bs-target="#exampleModalpopover">Modal with tooltip</button>
											<!-- Modal -->
											

											<!-- Button trigger modal -->
											<button type="button" class="btn btn-primary light mb-2" data-bs-toggle="modal" data-bs-target="#modalGrid">Grid Inside Modal</button>
											<!-- Modal -->
											

											<!-- Large modal -->
											<button type="button" class="btn btn-primary light mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Large modal</button>
											

											<!-- Small modal -->
											<button type="button" class="btn btn-primary light mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm">Small modal</button>
