													...
													<div class="tab-pane fade show active" id="AlertLink" role="tabpanel" aria-labelledby="home-tab-8">
														<div class="card-body pt-0">
															...
															<div class="alert alert-dark alert-dismissible fade show">
																...
																<strong>Error!</strong> Something Went wrong <a href="#" class="text-light">Click here for details.</a>
															</div>
															<div class="alert alert-light alert-dismissible fade show">
																<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"><span><i class="fa-solid fa-xmark"></i></span>
																</button>
															...
															<div class="row">
																<div class="col-xl-6">
																	<div class="alert alert-primary notification">
																		...
																		<button class="btn btn-primary light btn-sm">Confirm</button>
																		<button class="btn btn-link btn-sm link-secondary">Cancel</button>
																	</div>
																</div>
																<div class="col-xl-6">
