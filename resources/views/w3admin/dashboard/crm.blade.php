...
<div class="container-fluid">
	<h3 class="head-title">CRM</h5>
	<div class="row">
		<div class="col-xl-4 col-xxl-3 col-sm-6">
			<div class="card overflow-hidden">
				<div class="card-body">
					<div class="c-con">
						<h4 class="card-title mb-0">Congratulations <strong>Hanu!!</strong><img src="{{ asset('images/crm/party-popper.png')}}" alt=""></h4>
					...
					<div class="c-con-3d">
						<div class="c-con-prise">
							...
							<a href="javascript:void(0)" class="btn btn-primary light light btn-sm">View Sale</a>
						</div>
						<img src="{{ asset('images/crm/Object.png')}}">
					</div>	
				</div>
			</div>
		</div>
		<div class="col-xl-2 col-xxl-3 col-sm-6">
			<div class="card crm-cart bg-secondary-light">
				<div class="card-header border-0 pb-0 diposit-bg">
					<span class="text-black fs-16">+38%<i class="fa-solid fa-chevron-up ms-1"></i></span>
					<div class="icon-box">
						<svg width="15" height="15" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M11.4642 13.7074C11.4759 12.1252 10.8504 10.8738 9.60279 9.99009C8.6392 9.30968 7.46984 8.95476 6.33882 8.6137C3.98274 7.89943 3.29927 7.52321 3.29927 6.3965C3.29927 5.14147 4.93028 4.69493 6.32655 4.69493C7.34341 4.69493 8.51331 5.01109 9.23985 5.47964L10.6802 3.24887C9.73069 2.6333 8.43112 2.21342 7.14783 2.0831V0H4.49076V2.22918C2.12884 2.74876 0.640949 4.29246 0.640949 6.3965C0.640949 7.87005 1.25327 9.03865 2.45745 9.86289C3.37331 10.4921 4.49028 10.83 5.56927 11.1572C7.88027 11.8557 8.81873 12.2813 8.80805 13.691L8.80799 13.7014C8.80799 14.8845 7.24005 15.3051 5.89676 15.3051C4.62786 15.3051 3.248 14.749 2.46582 13.9222L0.535522 15.7481C1.52607 16.7957 2.96523 17.5364 4.4907 17.8267V20.0001H7.14783V17.8735C9.7724 17.4978 11.4616 15.9177 11.4642 13.7074Z" fill="#000"></path>
						</svg>
					</div>
				</div>
				<div class="card-body">
					<div class="crm-cart-data">
						<p>252$</p>
						<h6 class="d-block mb-3 text-black">Total Sales</h6>
		...
		<div class="col-xl-4">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title mb-0">Organic Traffic</h4>
				</div>
				<div class="card-body custome-tooltip">
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				...
				<div class="card-footer border-0 pt-0">
					<a href="javascript:void(0)" class="btn btn-primary light light btn-block">View Details</a>
				</div>
			</div>
		</div>
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title mb-0">Social Networking</h4>
				</div>
				<div class="card-body">
					<div class="mb-3">
					...
					<ul class="sociallinks">
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/crm/dribble.png')}}" class="avatar avatar-md">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  ...
							  <div class="d-flex align-items-center">
								...
								<span class="badge badge-sm badge-primary light border-0 ms-2">+36%</span>
							  </div>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/crm/facebook.png')}}" class="avatar avatar-md">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
							  ...
							  <div class="d-flex align-items-center">
								...
								<span class="badge badge-sm badge-danger light border-0 ms-2">-33%</span>
							  </div>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/crm/instagram.png')}}" class="avatar avatar-md">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
							  ...
							  <div class="d-flex align-items-center">
								...
								<span class="badge badge-sm badge-info light border-0 ms-2">-32%</span>
							  </div>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/crm/linkedin.png')}}" class="avatar avatar-md">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
							  ...
							  <div class="d-flex align-items-center">
								...
								<span class="badge badge-sm badge-success light border-0 ms-2">-32%</span>
							  </div>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/crm/pinterest.png')}}" class="avatar avatar-md">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
							  ...
							  <div class="d-flex align-items-center">
								...
								<span class="badge badge-sm badge-primary light border-0 ms-2">-32%</span>
							  </div>
							</div>
						</li>
					</ul>
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title mb-0">Yearly Income</h4>
				</div>
				<div class="card-body custome-tooltip">
					<div id="NewCustomers"></div>
					<p class="mt-5 mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the </p>
				</div>
			</div>
		</div>
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title mb-0">Meeting Plane</h4>
				</div>
				<div class="card-body">
					<ul class="sociallinks">
						<li class="d-flex">
							...
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-primary light  border-0 ms-2">Businessman</span>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
						...
						<li class="d-flex">
							...
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-success light border-0 ms-2">Accountant</span>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/contacts/pic777.jpg')}}" class="avatar avatar-md" alt="">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-info light  border-0 ms-2">Manager</span>
							</div>
						</li>
						<li class="d-flex">
							<div class="icon">
							  <img src="{{ asset('images/contacts/pic666.jpg')}}" class="avatar avatar-md" alt="">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title mb-0">External Data</h4>
				</div>
				<div class="card-body custome-tooltip pb-0">
					<ul class="crm-ads-list">
						<li>
							<div class="dots-crm">
								<span class="dots bg-primary-light"></span>
								<h6>Google Ads</h6>
							</div>	
							<span>$512k</span>
						...
						<li>
							<div class="dots-crm">
								<span class="dots bg-secondary-light"></span>
								<h6>Fb Analytics</h6>
							</div>
							<span>$86.2k</span>
						...
						<li>
							<div class="dots-crm">
								<span class="dots bg-danger-light"></span>
								<h6>Dribble User</h6>
							</div>	
							<span>$45.2k</span>
							<h6>58%<i class="fa-solid fa-chevron-down ms-2 text-danger"></i></h6>
						</li>
					</ul>
