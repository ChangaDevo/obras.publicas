			...
			<div class="card h-auto">
				<div class="card-body">
					<div class="c-profile text-center">
						<img src="{{ asset('images/user1.jpg')}}" class="rounded-circle mb-2">
					...
					<div class="d-flex mt-4 justify-content-end">
						...
						<button type="button" class="modal-btn btn btn-primary light btn-sm  ms-2 " data-bs-toggle="modal" data-bs-target="#exampleModal3">
			...
			<div class="card h-auto">
				<div class="card-body d-flex align-items-center justify-content-between flex-wrap">
					<div class="d-flex align-items-center c-busiess">
						<img src="{{ asset('images/economics.png')}}" class="avatar">
						<div>
					...
					<div>
						...
						<a href="javascript:void(0)" class="btn btn-primary light btn-sm ms-2">Update plan</a>
					</div>
				</div>
			</div>
			<div class="card h-auto">
				...
				<div class="card-body pt-0">
					<div class="row">
						<div class="col-xl-4 col-lg-4">
							<img src="{{ asset('images/credit.png')}}" alt="" class="w-100">
						</div>
	...
	<div class="modal-dialog">
	  <div class="modal-content">
		...
		<div class="modal-footer">
		  ...
		  <button type="button" class="btn btn-primary light btn-sm">Save changes</button>
		</div>
	  </div>
	</div>
</div>
