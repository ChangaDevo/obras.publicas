							...
							<div class="card bg-warning-light">
								<div class="card-header border-0 flex-wrap">
									...
									<div class="avatar-list avatar-list-stacked me-2">
										<img src="{{ asset('images/contacts/pic555.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
										<img src="{{ asset('images/contacts/pic666.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
										<a href="{{ url('app-profile-2')}}"><span class="avatar avatar-md rounded-circle bg-white">25+</span></a>
									</div>
								...
								<table id="projects-tbl" class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/contacts/pic888.jpg')}}" class="avatar rounded-circle" alt="">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/contacts/pic999.jpg')}}" class="avatar rounded-circle" alt="">
													<p class="mb-0 ms-2">Elijah James</p>	
												</div>
											</td>
											<td class="pe-0">
				...
				<div class="col-xl-4">
					<div class="card overflow-hidden">
						<div class="card-header flex-wrap">
							...
							<div class="d-flex">
								<a href="{{ url('contacts')}}" class="btn btn-link text-primary btn-sm">View All</a>
					...
					<div class="card-body schedules-cal p-2">
							...
							<div class="">
								<div class="event-media">
									<div class="d-flex align-items-center">
										...
										<div class="event-data ms-2">
											<h5 class="mb-0"><a href="{{ url('contacts')}}">Development planning</a></h5>
								...
								<div class="event-media">
									<div class="d-flex align-items-center">
										...
										<div class="event-data ms-2">
											<h5 class="mb-0"><a href="{{ url('contacts')}}">Desinging planning</a></h5>
											<span>w3it Technologies</span>
										</div>
									</div>
								...
								<div class="event-media">
									<div class="d-flex align-items-center">
										...
										<div class="event-data ms-2">
											<h5 class="mb-0"><a href="{{ url('contacts')}}">Frontend Designing</a></h5>
											<span>w3it Technologies</span>
										</div>
									</div>
								...
								<div class="event-media">
									<div class="d-flex align-items-center">
										...
										<div class="event-data ms-2">
											<h5 class="mb-0"><a href="{{ url('contacts')}}">Software planning</a></h5>
											<span>w3it Technologies</span>
										</div>
									</div>
						...
						<div class="contacts-group">	
							<div class="group-list d-flex align-items-center justify-content-between">
								...
								<a href="{{ url('contacts')}}" class="btn-link text-primary">View All</a>
							</div>	
							<div>
								<div class="friend-list1">
									<div class="d-flex">
										<a href="{{ url('contacts')}}">
											<div class="friend-user">
												<img src="{{ asset('images/profile/friends/f3.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Tony</p>
											</div>
										</a>	
										<a href="{{ url('contacts')}}">
											<div class="friend-user">
												<img src="{{ asset('images/contacts/pic2.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Lucas</p>
											</div>
										</a>	
										<a href="{{ url('contacts')}}">
											<div class="friend-user">
												<img src="{{ asset('images/contacts/pic3.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Oliver</p>
											</div>
										</a>
										<a href="{{ url('contacts')}}">	
											<div class="friend-user">
												<img src="{{ asset('images/profile/friends/f2.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Karen</p>
											</div>
										</a>	
									</div>
									<div class="d-flex">
										<a href="{{ url('contacts')}}">
											<div class="friend-user">
												<img src="{{ asset('images/contacts/pic1.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Donald</p>
											</div>	
										</a>
										<a href="{{ url('contacts')}}">															
											<div class="friend-user">
												<img src="{{ asset('images/contacts/d4.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Elijah</p>
											</div>
										</a>
										<a href="{{ url('contacts')}}">	
											<div class="friend-user">
												<img src="{{ asset('images/profile/friends/f4.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Lucas</p>
											</div>
										</a>	
										<a href="{{ url('contacts')}}">
											<div class="friend-user">
												<img src="{{ asset('images/profile/friends/f1.jpg')}}" class="avatar avatar-lg" alt="">
												<p>Karen</p>
											</div>
										</a>	
									</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel-1" aria-hidden="true">
	...
	<div class="modal-content">
		...
		<h5 class="modal-title" id="exampleModalLabel-1">Add Expenses</h5>
