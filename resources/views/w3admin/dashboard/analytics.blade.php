...
<div class="container-fluid">
	<h3 class="head-title">Analytcs</h3>
	<div class="row">
		<div class="col-xl-6">
			<div class="card overflow-hidden">
				<div class="card-body">
					<div class="any-card">
						<div class="c-con">
							<h4 class="heading mb-0">Congratulations <strong>Hanu!!</strong><img src="{{ asset('images/crm/party-popper.png')}}" alt=""></h4>
							...
							<a href="#" class="btn btn-primary light">View Profile</a>
						</div>
						<img src="{{ asset('images/analytics/developer_male.png')}}" class="harry-img">
		...
		<div class="col-xl-3 col-md-6">
			<div class="card bg-primary-light">
				<div class="card-header border-0">
					<h4 class="heading mb-0 text-black">Overview Of Sales 😎</h4>
				</div>
				<div class="card-body pb-0">
					<div class="row">
						<div class="col-xl-12">
							<div class="card sales-bx">
								<div class="card-body">
									<img src="{{ asset('images/analytics/sales.png')}}">
									<h4>$3,651</h4>
		...
		<div class="col-xl-12">
			<div class="card bg-secondary-light analytics-card">
				<div class="card-body mt-4 pb-1">
					<div class="row align-items-center"> 
						<div class="col-xl-2">
							<h3 class="mb-3">Analytics</h3>
							<p class="mb-0  pb-4">Yout statistics for<br> 1 month period.</p>
						</div>
						<div class="col-xl-10">
							<div class="row">
								<div class="col-xl-2 col-sm-4 col-6 social-cards">
									<div class="card ov-card">
										<div class="card-body">
											<div class="ana-box">	
												<div class="ic-n-bx">
													<div class="icon-box icon-box-md  bg-primary-light rounded-circle">
				...
				<div class="card-body pb-0">
					<div class="row align-items-center">
						...
						<div class="col-xl-9 custome-tooltip">
							<div id="chartBar" class="earning-chart"></div>
						</div>
					</div>
				</div>
			</div>
						...
						<li class="d-flex">
							...
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-primary light  border-0 ms-2">25.8%<i class="fa-solid fa-chevron-up ms-2"></i></span>
							</div>
						</li>
						<li class="d-flex">
							<div class="country-flag">
							...
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-secondary light  border-0 ms-2">18.5%<i class="fa-solid fa-chevron-down ms-2 "></i></span>
							</div>
						</li>
						<li class="d-flex">
							<div class="country-flag">
							...
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-info light  border-0 ms-2">59.5%<i class="fa-solid fa-chevron-up ms-2"></i></span>
							</div>
						</li>
						<li class="d-flex">
							<div class="country-flag">
							  <img src="{{ asset('images/country/united-kingdom')}}.png" alt="">
							</div>
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-success light  border-0 ms-2">60.5%<i class="fa-solid fa-chevron-up ms-2"></i></span>
							</div>
						</li>
						<li class="d-flex">
							<div class="country-flag">
						...
						<li class="d-flex">
							...
							<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
							  <div class="ms-2">
								...
								<span class="badge badge-sm badge-light  border-0 ms-2">60.5%<i class="fa-solid fa-chevron-down ms-2 "></i></span>
							</div>
						</li>
						<li class="d-flex">
							<div class="country-flag">
						...
						<div class="card-body d-flex justify-content-between align-items-center">
							<div class="d-flex sales-data">
								<div class="icon-box icon-box-md bg-primary-light me-1">
									<i class="fa-solid fa-user primary-black"></i>
								</div>
								<div class="ms-2">
									<h4 class="mb-0">4,613k</h4>
				...
				<div class="col-xl-6 col-sm-6">
					<div class="card">
						<div class="card-body d-flex justify-content-between align-items-center">
							...
							<a href="javascript:void(0)"><i class="fa-solid fa-chevron-right text-black"></i></a>
						</div>
					</div>
				</div>
			</div>
