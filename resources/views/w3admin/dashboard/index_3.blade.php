...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-xl-7 same-card">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Traffic Update</h4>
				</div>
										...
										<div class="icon-box  rounded-circle">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="15px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													...
													<path d="M18,8 L16,8 C15.4477153,8 15,7.55228475 15,7 C15,6.44771525 15.4477153,6 16,6 L18,6 L18,4 C18,3.44771525 18.4477153,3 19,3 C19.5522847,3 20,3.44771525 20,4 L20,6 L22,6 C22.5522847,6 23,6.44771525 23,7 C23,7.55228475 22.5522847,8 22,8 L20,8 L20,10 C20,10.5522847 19.5522847,11 19,11 C18.4477153,11 18,10.5522847 18,10 L18,8 Z M9,11 C6.790861,11 5,9.209139 5,7 C5,4.790861 6.790861,3 9,3 C11.209139,3 13,4.790861 13,7 C13,9.209139 11.209139,11 9,11 Z" fill="black" fill-rule="nonzero" opacity="0.3"/>
													<path d="M0.00065168429,20.1992055 C0.388258525,15.4265159 4.26191235,13 8.98334134,13 C13.7712164,13 17.7048837,15.2931929 17.9979143,20.2 C18.0095879,20.3954741 17.9979143,21 17.2466999,21 C13.541124,21 8.03472472,21 0.727502227,21 C0.476712155,21 -0.0204617505,20.45918 0.00065168429,20.1992055 Z" fill="black" fill-rule="nonzero"/>
												</g>
											</svg>
										</div>
										...
										<div class="icon-box  rounded-circle">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="15px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													...
													<path d="M10.9630156,7.5 L11.0475062,7.5 C11.3043819,7.5 11.5194647,7.69464724 11.5450248,7.95024814 L12,12.5 L15.2480695,14.3560397 C15.403857,14.4450611 15.5,14.6107328 15.5,14.7901613 L15.5,15 C15.5,15.2109164 15.3290185,15.3818979 15.1181021,15.3818979 C15.0841582,15.3818979 15.0503659,15.3773725 15.0176181,15.3684413 L10.3986612,14.1087258 C10.1672824,14.0456225 10.0132986,13.8271186 10.0316926,13.5879956 L10.4644883,7.96165175 C10.4845267,7.70115317 10.7017474,7.5 10.9630156,7.5 Z" fill="#000"/>
													<path d="M7.38979581,2.8349582 C8.65216735,2.29743306 10.0413491,2 11.5,2 C17.2989899,2 22,6.70101013 22,12.5 C22,18.2989899 17.2989899,23 11.5,23 C5.70101013,23 1,18.2989899 1,12.5 C1,11.5151324 1.13559454,10.5619345 1.38913364,9.65805651 L3.31481075,10.1982117 C3.10672013,10.940064 3,11.7119264 3,12.5 C3,17.1944204 6.80557963,21 11.5,21 C16.1944204,21 20,17.1944204 20,12.5 C20,7.80557963 16.1944204,4 11.5,4 C10.54876,4 9.62236069,4.15592757 8.74872191,4.45446326 L9.93948308,5.87355717 C10.0088058,5.95617272 10.0495583,6.05898805 10.05566,6.16666224 C10.0712834,6.4423623 9.86044965,6.67852665 9.5847496,6.69415008 L4.71777931,6.96995273 C4.66931162,6.97269931 4.62070229,6.96837279 4.57348157,6.95710938 C4.30487471,6.89303938 4.13906482,6.62335149 4.20313482,6.35474463 L5.33163823,1.62361064 C5.35654118,1.51920756 5.41437908,1.4255891 5.49660017,1.35659741 C5.7081375,1.17909652 6.0235153,1.2066885 6.2010162,1.41822583 L7.38979581,2.8349582 Z" fill="#000" opacity="1"/>
												</g>
											</svg>
										</div>
										<div class="ms-2 add-visit">
									...
									<div class="d-flex diposit-bg">
										<div class="icon-box rounded-circle">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="15px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24"/>
													<path d="M12,11 C9.790861,11 8,9.209139 8,7 C8,4.790861 9.790861,3 12,3 C14.209139,3 16,4.790861 16,7 C16,9.209139 14.209139,11 12,11 Z" fill="#000" fill-rule="nonzero" opacity="0.3"/>
													<path d="M3.00065168,20.1992055 C3.38825852,15.4265159 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.72750223,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z" fill="#000" fill-rule="nonzero"/>
												</g>
											</svg>
										</div>
										<div class="ms-2 add-visit">
		...
		<div class="col-xl-5 same-card">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title mb-0">Sales statistics</h4>
				</div>
				<div class="card-body custome-tooltip">
					<div class="row">
						<div class="col-xl-3 col-6 or-series">
							<div class="card text-center">
								<div class="card-body add-visit p-2">
						...
						<div class="col-xl-3 col-6 or-series">
							<div class="card text-center">
								<div class="card-body p-2 add-visit">
		...
		<div class="col-xl-8">
			<div class="row">
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title mb-0">Market Update</h4>
						</div>
								...
								<table id="empoloyeestbl2" class="table market-update">
									...
									<tbody>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/dribble.png')}}" class="avatar avatar-md" alt="">
											...
											<td class="text-black">$4,3655</td>
											<td><span class="badge badge-sm badge-success light border-0">Active</span></td>
											<td class="text-center">
												<div class="dropdown">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/facebook.png')}}" class="avatar avatar-md" alt="">
													<div class="ms-2 dr-data">
											...
											<td class="text-black">$3,2342</td>
											<td><span class="badge badge-sm badge-danger light border-0">Inactive</span></td>
											<td class="text-center">
												<div class="dropdown">
													<div class="btn-link" data-bs-toggle="dropdown" aria-expanded="false" role="">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M11 12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12Z" stroke="#737B8B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
															<path d="M18 12C18 12.5523 18.4477 13 19 13C19.5523 13 20 12.5523 20 12C20 11.4477 19.5523 11 19 11C18.4477 11 18 11.4477 18 12Z" stroke="#737B8B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
															<path d="M4 12C4 12.5523 4.44772 13 5 13C5.55228 13 6 12.5523 6 12C6 11.4477 5.55228 11 5 11C4.44772 11 4 11.4477 4 12Z" stroke="#737B8B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/instagram.png')}}" class="avatar avatar-md" alt="">
													<div class="ms-2 dr-data">
														<h6 class="mb-0">Facebook</h6>
														<span>60 Ads</span>
													</div>
											...
											<td class="text-black">$4,3655</td>
											<td><span class="badge badge-sm badge-success light border-0">Deactive</span></td>
											<td class="text-center">
												<div class="dropdown">
													<div class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/linkedin.png')}}" class="avatar avatar-md" alt="">
													<div class="ms-2 dr-data">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/bing.png')}}" class="avatar avatar-md" alt="">
													<div class="ms-2 dr-data">
											...
											<td class="text-success"><i class="fa-solid fa-arrow-trend-down me-1"></i> 2.556</td>
											<td class="text-black">$4,3655</td>
											<td><span class="badge badge-sm badge-primary light border-0">Pending</span></td>
											<td class="text-center">
												<div class="dropdown">
													<div class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/twitter.png')}}" class="avatar avatar-md" alt="">
													<div class="ms-2 dr-data">
											...
											<td class="text-danger"><i class="fa-solid fa-arrow-trend-down me-1"></i> 2.556</td>
											<td class="text-black">$4,3655</td>
											<td><span class="badge badge-sm badge-danger light border-0">Pending</span></td>
											<td class="text-center">
												<div class="dropdown">
													<div class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/crm/whatsapp.png')}}" class="avatar avatar-md" alt="">
													<div class="ms-2 dr-data">
					...
					<div class="card sale-card">
						<div class="card-header pb-0 border-0 align-items-baseline">
							<div class="add-visit">
								...
								<h3>$1,255 <i class="fa-solid fa-arrow-trend-up ms-1"></i></h3>
							</div>
							<span class="badge badge-sm badge-primary light border-0">3.5<i class="fa-solid fa-caret-up ms-1"></i></span>
						</div>
						<div class="card-body p-0 custome-tooltip">
							<div id="totalSale"></div>
						</div>
						<div class="card-footer border-0">
							<span class="tag bg-primary-light">
					...
					<div class="card sale-card">
						<div class="card-header pb-0 border-0 align-items-baseline">
							<div class="add-visit">
								...
								<h3>5,552k <i class="fa-solid fa-arrow-trend-down ms-1"></i></h3>
							</div>
							<span class="badge badge-sm badge-danger light border-0">5.5<i class="fa-solid fa-caret-down ms-1"></i></span>
						</div>
						<div class="card-body p-0 custome-tooltip">
							<div id="totalPurchase"></div>
						</div>
						<div class="card-footer border-0">
							<span class="tag bg-danger-light">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
							</span>
						</div>	
					</div>
					...
					<div class="card sale-card">
						<div class="card-header pb-0 border-0 align-items-baseline">
							<div class="add-visit">
								...
								<h3>3,431k <i class="fa-solid fa-arrow-trend-up ms-1"></i></h3>
							</div>
							<span class="badge badge-sm badge-info light border-0">6.5<i class="fa-solid fa-caret-down ms-1"></i></span>
						</div>
						<div class="card-body p-0 custome-tooltip">
							<div id="activeCustomers"></div>
						</div>
						<div class="card-footer border-0">
							<span class="tag bg-info-light">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
							</span>
						</div>	
					</div>
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header border-0 chart-card flex-wrap">
							<div class="d-flex align-items-center sm-mb-0 mb-2">
								<img src="{{ asset('images/crm/pie-chart.png')}}" alt="">
								<div class="ms-2">
							...
							<div class="d-flex align-items-center sm-mb-0 mb-2">
								<div class="icon-box bg-primary-light rounded-circle">
									<svg width="15" height="15" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd" clip-rule="evenodd" d="M32.8961 26.5849C34.1612 26.5849 35.223 27.629 35.0296 28.8783C33.8947 36.2283 27.6026 41.6855 20.0138 41.6855C11.6178 41.6855 4.8125 34.8803 4.8125 26.4862C4.8125 19.5704 10.0664 13.1283 15.9816 11.6717C17.2526 11.3579 18.5553 12.252 18.5553 13.5605C18.5553 22.4263 18.8533 24.7197 20.5368 25.9671C22.2204 27.2145 24.2 26.5849 32.8961 26.5849Z" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										<path fill-rule="evenodd" clip-rule="evenodd" d="M41.1733 19.2019C41.2739 13.5059 34.2772 4.32428 25.7509 4.48217C25.0877 4.49402 24.5568 5.04665 24.5272 5.70783C24.3121 10.3914 24.6022 16.4605 24.764 19.2118C24.8134 20.0684 25.4864 20.7414 26.341 20.7907C29.1693 20.9526 35.4594 21.1736 40.0759 20.4749C40.7035 20.3802 41.1634 19.8355 41.1733 19.2019Z" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
									</svg>
								</div>
								<div class="ms-2">
									<h4 class="mb-0">1,6532k <small class="fs-12 text-success"><i class="fa-solid fa-arrow-trend-up mx-2"></i>(5.66)</small></h4>
									<span>Lorem Ipsum</span>
								</div>
							</div>
							<div class="d-flex align-items-center sm-mb-0 mb-2">
								<div class="icon-box bg-secondary-light rounded-circle">
									<svg width="20" height="20" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd" clip-rule="evenodd" d="M22.9717 41.0539C22.9717 41.0539 37.3567 36.6983 37.3567 24.6908C37.3567 12.6814 37.878 11.7439 36.723 10.5889C35.5699 9.43391 24.858 5.69891 22.9717 5.69891C21.0855 5.69891 10.3736 9.43391 9.21863 10.5889C8.0655 11.7439 8.58675 12.6814 8.58675 24.6908C8.58675 36.6983 22.9717 41.0539 22.9717 41.0539Z" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M26.4945 26.4642L19.4482 19.4179" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M19.4487 26.4642L26.495 19.4179" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
									</svg>
								</div>
								<div class="ms-2">
									<h4 class="mb-0">7:03:13<small class="fs-12 text-success"><i class="fa-solid fa-arrow-trend-down mx-2"></i>(3.56)</small></h4>
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header border-0 chart-card flex-wrap">
							<div class="d-flex align-items-center sm-mb-0 mb-2">
								<img src="{{ asset('images/crm/pie-chart2.png')}}" alt="">
								<div class="ms-2">
									<h4 class="mb-0">2,142k <small class="fs-12 text-primary"><i class="fa-solid fa-arrow-trend-down mx-2"></i>(4.56)</small></h4>
									<span>Lorem Ipsum</span>
								</div>
							</div>
							<div class="d-flex align-items-center sm-mb-0 mb-2">
								...
								<div class="ms-2">
									<h4 class="mb-0">1,5832k <small class="fs-12 text-primary"><i class="fa-solid fa-arrow-trend-up mx-2"></i>(6.76)</small></h4>
									<span>Lorem Ipsum</span>
								</div>
							</div>
							<div class="d-flex align-items-center sm-mb-0 mb-2">
		...
		<div class="col-xl-4">
			<div class="row">
				<div class="col-xl-6 col-sm-6 same-card">
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between">
								...
								<div class="total-projects">
									<h4 class="text-info count">67%</h4> 
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between">
								...
								<div class="total-projects">
									<h4 class="secondary-text count">57%</h4> 
