				...
				<div class="card-body">
					<div class="basic-form">
						<form>
							...
							<button type="submit" class="btn btn-primary light">Sign in</button>
						</form>
					</div>
				</div>
			</div>
				...
				<div class="card-body">
					<div class="basic-form">
						<form class="d-flex align-items-center flex-wrap flex-sm-nowrap">
							...
							<button type="submit" class="btn btn-primary light mb-2">Confirm identity</button>
						</form>
					</div>
				</div>
			</div>
					...
					<div class="basic-form">
						<form>
							...
							<div class="row align-items-center">
								...
								<div class="col-12">
									<button type="submit" class="btn btn-primary light mb-2">Submit</button>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="basic-form">
						<form>
							...
							<fieldset disabled>
								...
								<button type="submit" class="btn btn-primary light mt-3">Submit</button>
							</fieldset>
						</form>
					</div>
				</div>
				...
				<div class="card-body">
					<div class="basic-form">
						<form action="#">
							@csrf
							<div class="input-group mb-3">
								<button class="btn btn-primary light dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
				...
				<div class="card-body">
					<div class="basic-form">
						<form action="#">
							@csrf
							<div class="input-group mb-3">
								<button type="button" class="btn btn-primary light">Action</button>
