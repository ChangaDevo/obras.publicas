			...
			<div class="card overflow-hidden">
				<div class="card-body p-0">
					<div class="row gx-0">
						...
						<div class="col-xl-3 col-lg-6 col-sm-5 chat-border mobile-chat chat-left-area">
							<div class="chat-p shaprate">
								<div class="d-flex align-items-center">
									<img src="{{ asset('images/contacts/d1.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
									<div class="ms-2">
							...
							<div class="c-list">
								<div class="input-group search-area">
									...
									<svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
										<circle cx="8.82495" cy="9.32491" r="6.74142" stroke="#252525" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M13.5137 14.3638L16.1568 16.9999" stroke="#252525" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
									</a></span>
								</div>
							</div>
							<div class="people-list dz-scroll">
								<div class="chat-p style-1">
									<div class="d-flex">
										<img src="{{ asset('images/contacts/d1.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
										<div class="ms-2">
											<h6 class="mb-0">Honey Risher</h6>
								...
								<div class="chat-p style-1">
									<div class="d-flex active">
										<img src="{{ asset('images/contacts/d4.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
										<div class="ms-2">
								...
								<div class="chat-p style-1">
									<div class="d-flex">
										<img src="{{ asset('images/contacts/d2.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
										<div class="ms-2">
											<h6 class="mb-0">Ricky M</h6>
											<span><strong>You:</strong> Welcome back </span>	
										</div>	
									</div>
									<span>5 mIn</span>
								...
								<div class="chat-p style-1">
									<div class="d-flex active">
										<img src="{{ asset('images/contacts/d4.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
										<div class="ms-2">
											<h6 class="mb-0">Ankites Risher</h6>
											<span><strong>You:</strong> Welcome back </span>	
										</div>	
									</div>
									<span>2 mIn</span>
						...
						<div class="col-xl-5 col-lg-6 col-sm-7 chat-border">
							<div class="chat-p shaprate">
								...
								<div class="chat-admin">
									...
									<div class="icon-box bg-success-light mx-1">
										<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="icon-box bg-primary-light mx-1">
							...
							<div class="chat-box-area style-2 dz-scroll" id="chartBox2">
								...
								<div class="media justify-content-end align-items-end ms-auto">
									<div class="message-sent w-auto">
										...
										<p>Even the all-powerful Pointing has no control about the blind texts it is an<br>
											almost unorthographic life One day however a small line of blind text by the <br>
											name of Lorem Ipsum decided to leave for the far World of Grammar. Aenean <br>
											vulputate eleifend tellus. Aenean leo ligula.</p>
										<span class="fs-12 mb-3 d-block">9.30 AM</span>
									</div>
								</div>	
								<div class="media">
									<div class="message-received w-auto">
										<div class="d-flex">
											...
											<div class="ms-1 text">
												...
												<p class="mb-3">Can you arrange schedule for next meeting?</p>
												<span>12:45 PM</span>
											</div>	
										</div>
									</div>
							...
							<div class="message-send style-2">
								...
								<button type="button" class="btn btn-primary light light p-2 d-flex align-items-center">
									Send
						...
						<div class="col-xl-4 file-media dz-scroll">
							<div class="chat-meadia">
								<h4 class="card-title">Media</h4>
								<ul class="image-list">
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/1.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/3.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/2.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/5.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/4.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/2.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/4.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/1.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/4.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/3.png')}}" alt=""></a></li>
									<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/2.png')}}" alt=""></a></li>
									<li class="all-media"><a href="javascript:void(0);"><span>50+</span><img src="{{ asset('images/chat/5.png')}}" alt=""></a></li>
								</ul>
							</div>
							<div class="chat-meadia">
								...
								<div class="file-list row">
									<div class="text-center col-xl-4 col-6 filie-l-icon">
										<img src="{{ asset('images/chat/google-docs1.png')}}" alt="">
										<h5>document.doc</h5>
										<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
									</div>
									<div class="text-center col-xl-4 col-6 filie-l-icon">
										<img src="{{ asset('images/chat/play-button1.png')}}" alt="">
										<h5>document.doc</h5>
										<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
									</div>
									<div class="text-center col-xl-4 col-6 filie-l-icon">
										<img src="{{ asset('images/chat/music-notes1.png')}}" alt="">
										<h5>document.doc</h5>
										<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
									</div>
									<div class="text-center col-xl-4 col-6 filie-l-icon">
										<img src="{{ asset('images/chat/pdf.png')}}" alt="">
										<h5>Project 01</h5>
										<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
									</div>
									<div class="text-center col-xl-4 col-6 filie-l-icon">
