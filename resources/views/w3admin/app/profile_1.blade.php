						...
						<div class="card-body">
							<div class="profile-statistics">
								<div class="text-center">
									...
									<div class="mt-4">
										<a href="javascript:void(0);" class="btn btn-primary light light mb-1 me-1">Follow</a> 
										<a href="javascript:void(0);" class="btn btn-primary light light mb-1" data-bs-toggle="modal" data-bs-target="#sendMessageModal">Send Message</a>
									</div>
								</div>
								<!-- Modal -->
							</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="profile-news">
								<h5 class="text-primary card-title d-inline">Our Latest News</h5>
							...
							<div class="tab-content">
								<div id="my-posts" class="tab-pane fade active show">
									<div class="my-post-content pt-3">
										<div class="post-input">
											...
											<a href="javascript:void(0);" class="btn btn-primary light light light me-1 px-3" data-bs-toggle="modal" data-bs-target="#linkModal"><i class="fa fa-link m-0"></i> </a>
											<!-- Modal -->
											
											<a href="javascript:void(0);" class="btn btn-primary light light light me-1 px-3" data-bs-toggle="modal" data-bs-target="#cameraModal"><i class="fa fa-camera m-0"></i> </a>
											<!-- Modal -->
											
											<a href="javascript:void(0);" class="btn btn-primary light light" data-bs-toggle="modal" data-bs-target="#postModal">Post</a>
											<!-- Modal -->
										</div>
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											...
											<button class="btn btn-primary light light me-2"><span class="me-2"><i
								...
								<div id="about-me" class="tab-pane fade">
									...
									<div class="profile-skills mb-5">
										...
										<a href="javascript:void(0);" class="btn btn-primary light light light btn-xs mb-1">Admin</a>
										<a href="javascript:void(0);" class="btn btn-primary light light light btn-xs mb-1">Dashboard</a>
										<a href="javascript:void(0);" class="btn btn-primary light light light btn-xs mb-1">Photoshop</a>
										<a href="javascript:void(0);" class="btn btn-primary light light light btn-xs mb-1">Bootstrap</a>
										<a href="javascript:void(0);" class="btn btn-primary light light light btn-xs mb-1">Responsive</a>
										<a href="javascript:void(0);" class="btn btn-primary light light light btn-xs mb-1">Crypto</a>
									</div>
									...
									<div class="pt-3">
										<div class="settings-form">
											...
											<form>
												...
												<button class="btn btn-primary light light" type="submit">Sign
													in</button>
											</form>
										</div>
									</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="input-group custom_file_input mb-3">
					<span class="input-group-text border-0">Upload</span>
					<div class="form-file">
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				 ...
				 <a class="btn btn-primary light light mt-2" href="javascript:void(0)">Post</a>																		 
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary light light">Reply</button>
			</div>
		</div>
	</div>
</div>
			...
			<div class="modal-body">
				<form class="comment-form">
					...
					<div class="row"> 
						...
						<div class="col-lg-12">
							<div class="mb-3 mb-0">
								<input type="submit" value="Post Comment" class="submit btn btn-primary light light" name="submit">
							</div>
						</div>
					</div>
				</form>
