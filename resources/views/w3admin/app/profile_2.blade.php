			...
			<div class="card card-profile">
				<div class="admin-user">
					<div class="img-wrraper">                              
						<div class="">
							<img src="{{ asset('images/user.jpg')}}" class="rounded-circle"></div>
						<a class="icon-wrapper" href="{{ url('edit-profile')}}"><i class="fa-solid fa-pencil"></i></a>
					</div>
									  ...
									  <div class="accordion-body pb-0">
										<div class="about-me">
											<ul>
												...
												<div>
													<a href="javascript:void(0)" class="btn btn-block bg-facebook mb-2"><i class="fa-brands fa-facebook-f me-2"></i>Facebook</a>
													<a href="javascript:void(0)" class="btn btn-block bg-whatsapp mb-2"><i class="fa-brands fa-whatsapp me-2"></i>WhatsApp</a>
													<a href="javascript:void(0)" class="btn btn-block bg-skype mb-2"><i class="fa-brands fa-skype me-2"></i>Skype</a>
												</div>
											</ul>
										</div>
											...
											<div class="profile-news">
												<div class="media pt-3 pb-3">
													...
													<div class="media-body">
														<h6 class="m-b-5"><a href="{{ url('post-details')}}" class="text-black">Collection of textile samples</a></h6>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header border-0">
							<div class="products">
								<img src="{{ asset('images/user.jpg')}}" class="avatar avatar-md rounded-circle" alt="">
								<div>
							...
							<div class="dropdown custom-dropdown ">
								<div class="btn sharp btn-primary light tp-btn  ms-3" data-bs-toggle="dropdown">
						...
						<div class="card-body pt-0">
							<div class="post-img">
								<img src="{{ asset('images/post/post1.jpg')}}">	
							</div>
					...
					<div class="card">
						...
						<div class="card-body pt-0">
							<div class="row">
								<div class="col-xl-6">
									<div class="post-img">
										<img src="{{ asset('images/post/post11.jpg')}}" class="me-3">	
									</div>	
								</div>
								<div class="col-xl-6">
									<div class="post-img">
										<img src="{{ asset('images/post/post12.jpg')}}" class="ms-3">	
									</div>	
								</div>
							</div>
							<div class="post-see d-flex align-items-center mt-3">
				...
				<div class="col-xl-12">
					<div class="card">
						...
						<div class="card-body pt-0">
							<div class="post-img">
								<img src="{{ asset('images/post/post2.jpg')}}">	
							</div>
							<div class="post-see d-flex align-items-center mt-3">
							  <ul>
								<div class="avatar-list avatar-list-stacked">
					...
					<div class="card">
						...
						<div class="card-body pt-0">
							<div class="row">
								<div class="col-xl-6">
									<div class="post-img"> 
										<img src="{{ asset('images/post/post12.jpg')}}" class="me-3">	
									</div>
									
								</div>
								<div class="col-xl-6">
									<div class="post-img"> 
									  <img src="{{ asset('images/post/post13.jpg')}}" class="ms-3">	
									</div>  
								</div>
							</div>
							<div class="post-see d-flex align-items-center mt-3">
