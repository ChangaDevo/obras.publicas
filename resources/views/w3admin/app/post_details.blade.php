						...
						<div class="card-body">
							<div class="profile-statistics">
								<div class="text-center">
									...
									<div class="mt-4">
										<a href="javascript:void();;" class="btn btn-primary light light mb-1 me-1">Follow</a> 
										<a href="javascript:void();;" class="btn btn-primary light light mb-1" data-bs-toggle="modal" data-bs-target="#sendMessageModal">Send Message</a>
									</div>
								</div>
								<!-- Modal -->
				...
				<div class="card-body">
					<div class="post-details">
						...
						<div class="profile-skills mt-5 mb-5">
							...
							<a href="javascript:void();;" class="btn btn-primary light light light btn-xs mb-1">Admin</a>
							<a href="javascript:void();;" class="btn btn-primary light light light btn-xs mb-1">Dashboard</a>
							<a href="javascript:void();;" class="btn btn-primary light light light btn-xs mb-1">Photoshop</a>
							<a href="javascript:void();;" class="btn btn-primary light light light btn-xs mb-1">Bootstrap</a>
							<a href="javascript:void();;" class="btn btn-primary light light light btn-xs mb-1">Responsive</a>
							<a href="javascript:void();;" class="btn btn-primary light light light btn-xs mb-1">Crypto</a>
						</div>
						<div class="comment-respond" id="respond">
							...
							<form class="comment-form" id="commentform" method="post">
								...
								<div class="row"> 
									...
									<div class="col-lg-12">
										<div class="mb-3">
											<input type="submit" value="Post Comment" class="submit btn btn-primary light light" id="submit" name="submit">
										</div>
									</div>
								</div>
							</form>
