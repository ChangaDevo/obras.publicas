			...
			<div class="clearfix">
				<div class="card card-bx profile-card author-profile m-b30">
					<div class="card-body">
						...
						<div class="info-list">
							<ul>
								<li><a href="{{ url('app-profile-2')}}">Models</a><span>36</span></li>
								<li><a href="{{ url('uc-lightgallery')}}">Gallery</a><span>3</span></li>
								<li><a href="{{ url('app-profile-1')}}">Lessons</a><span>1</span></li>
							</ul>
						</div>
					</div>
		...
		<div class="col-xl-9 col-lg-8">
			<div class="card profile-card card-bx m-b30">
				...
				<form class="profile-form">
					...
					<div class="card-footer">
						<button class="btn btn-primary light light">UPDATE</button>
						<a href="{{ url('page-register')}}" class="btn-link ms-3">Forgot your password?</a>
					</div>
				</form>
			</div>
		</div>
