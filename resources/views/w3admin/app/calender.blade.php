				...
				<div class="card-body">
					...
					<div class="">
						<div id="external-events" class="my-3">
							...
							<div class="external-event btn-primary light light" data-class="bg-primary"><i class="fa fa-move"></i><span>New Theme Release</span></div>
						...
						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add-category" class="btn btn-primary light btn-event w-100">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary light waves-effect waves-light save-category" data-bs-toggle="modal">Save</button>
					</div>
				</div>
			</div>
		</div>
