	...
	<div class="row">
						...
						<ul class="timeline">
							...
							<li>
								...
								<a class="timeline-panel " href="#">
									...
									<h6 class="mb-0">john just buy your product <strong class="text-danger">Sell $250</strong></h6>
								</a>
							</li>
							<li>
						...
						<ul class="timeline">
							<li>
								<div class="timeline-panel">
									...
									<div class="dropdown">
										<button type="button" class="btn btn-primary light light sharp" data-bs-toggle="dropdown">
							...
							<li>
								<div class="timeline-panel">
									...
									<div class="dropdown">
										<button type="button" class="btn btn-danger light  light sharp" data-bs-toggle="dropdown">
											<svg width="15px" height="15px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#000000" cx="5" cy="12" r="2"/><circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="19" cy="12" r="2"/></g></svg>
										</button>
										<div class="dropdown-menu dropdown-menu-end">
											<a class="dropdown-item" href="#">Edit</a>
						...
						<ul class="timeline">
							...
							<li>
								<div class="timeline-panel">
									...
									<div class="media-body">
										<h5 class="mb-1">Resport created successfully <span class="badge badge-sm  badge-warning light">Warning</span></h5>
										<small class="d-block">29 July 2020 - 02:26 PM</small>
									</div>
									<div class="dropdown">
										<button type="button" class="btn btn-info light sharp" data-bs-toggle="dropdown">
							...
							<li>
							 ...
							 <li>
								<div class="timeline-panel">
									...
									<div class="media-body">
										<h5 class="mb-1">Dr sultads Send you Photo <span class="badge badge-sm  badge-danger light">Danger</span></h5>
										<small class="d-block">29 July 2020 - 02:26 PM</small>
									</div>
									<div class="dropdown">
										<button type="button" class="btn btn-primary light light sharp" data-bs-toggle="dropdown">
							...
							<li>
								<div class="timeline-panel">
									...
									<div class="media-body">
										<h5 class="mb-1">Resport created successfully <span class="badge badge-sm  badge-success light ">Success</span></h5>
										<small class="d-block">29 July 2020 - 02:26 PM</small>
									</div>
									<div class="dropdown">
										<button type="button" class="btn btn-danger light  light sharp" data-bs-toggle="dropdown">
							...
							<li>
								<div class="timeline-panel">
									...
									<div class="media-body">
										<h5 class="mb-1">Reminder : Treatment Time! <span class="badge badge-sm  badge-success light ">Success</span></h5>
										<small class="d-block">29 July 2020 - 02:26 PM</small>
									</div>
									<div class="dropdown">
										<button type="button" class="btn btn-primary light light sharp" data-bs-toggle="dropdown">
							...
							<li>
								<div class="timeline-panel">
									...
									<div class="media-body">
										...
										<a href="#" class="btn btn-primary light btn-xxs shadow">Reply</a>
										<a href="#" class="btn btn-danger light  btn-xxs">Delete</a>
									</div>
									<div class="dropdown">
										<button type="button" class="btn btn-primary light light sharp" data-bs-toggle="dropdown">
											<svg width="15px" height="15px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#000000" cx="5" cy="12" r="2"/><circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="19" cy="12" r="2"/></g></svg>
					...
					<div class="depostit-card-media d-flex justify-content-between">
						...
						<div class="icon-box">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M8 3V3.5C8 4.32843 8.67157 5 9.5 5H14.5C15.3284 5 16 4.32843 16 3.5V3H18C19.1046 3 20 3.89543 20 5V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V5C4 3.89543 4.89543 3 6 3H8Z" fill="#252525"></path>
								<path fill-rule="evenodd" clip-rule="evenodd" d="M10.875 15.75C10.6354 15.75 10.3958 15.6542 10.2042 15.4625L8.2875 13.5458C7.90417 13.1625 7.90417 12.5875 8.2875 12.2042C8.67083 11.8208 9.29375 11.8208 9.62917 12.2042L10.875 13.45L14.0375 10.2875C14.4208 9.90417 14.9958 9.90417 15.3792 10.2875C15.7625 10.6708 15.7625 11.2458 15.3792 11.6292L11.5458 15.4625C11.3542 15.6542 11.1146 15.75 10.875 15.75Z" fill="#252525"></path>
								<path fill-rule="evenodd" clip-rule="evenodd" d="M11 2C11 1.44772 11.4477 1 12 1C12.5523 1 13 1.44772 13 2H14.5C14.7761 2 15 2.22386 15 2.5V3.5C15 3.77614 14.7761 4 14.5 4H9.5C9.22386 4 9 3.77614 9 3.5V2.5C9 2.22386 9.22386 2 9.5 2H11Z" fill="#252525"></path>
								</g>
								<defs>
			...
			<div class="widget-stat card">
				<div class="card-body p-4">
					<div class="media ai-icon">
						<span class="me-3 bg-warning-light">
						...
						<div class="media-body">
							...
							<span class="badge badge-sm  badge-warning light">+3.5%</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body  p-4">
					<div class="media ai-icon">
						...
						<div class="media-body">
							...
							<span class="badge badge-sm  badge-danger light">-3.5%</span>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="students1 d-flex align-items-center justify-content-between flex-wrap">
						...
						<div>
							<div class="d-inline-block position-relative donut-chart-sale mb-3">
								<span class="donut1" data-peity='{ "fill": ["rgb(207, 248, 89)", "rgba(245, 245, 245, 1"],   "innerRadius": 33, "radius": 10}'>5/7</span>
								<small>62%</small>
							</div>
						</div>
					</div>
			...
			<div class="card">
				<div class="card-body">	
					<div class="students1 d-flex align-items-center justify-content-between flex-wrap">
						...
						<div>
							<div class="d-inline-block position-relative donut-chart-sale mb-3">
								<span class="donut1" data-peity='{ "fill": ["rgb(255, 204, 192)", "rgba(245, 245, 245, 1"],   "innerRadius": 33, "radius": 10}'>5/8</span>
								<small>38%</small>
							</div>
						</div>
					</div>
		...
		<div class="col-xl-3  col-lg-6 col-sm-6">
			<div class="widget-stat card bg-danger-light">
				<div class="card-body  p-4">
					<div class="media">
						<span class="me-3">
							<i class="la la-users text-black"></i>
						</span>
						<div class="media-body">
							<p class="mb-1 text-black">Total Students</p>
							<h3 class="">3280</h3>
							<div class="progress mb-2 bg-secondary">
								<div class="progress-bar progress-animated bg-black" style="width: 80%"></div>
							</div>
							<small class="text-black">80% Increase in 20 Days</small>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3  col-lg-6 col-sm-6">
			<div class="widget-stat card bg-warning-light">
				<div class="card-body p-4">
					<div class="media">
						<span class="me-3">
							<i class="la la-user text-black"></i>
						</span>
						<div class="media-body">
							<p class="mb-1 text-black">New Students</p>
							<h3 class="">245</h3>
							<div class="progress mb-2 bg-primary-light">
								<div class="progress-bar progress-animated bg-black" style="width: 50%"></div>
							</div>
							<small class="text-black">50% Increase in 25 Days</small>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3  col-lg-6 col-sm-6">
			<div class="widget-stat card bg-danger-light">
				<div class="card-body p-4">
					<div class="media">
						<span class="me-3">
							<i class="la la-dollar text-black"></i>
						</span>
						<div class="media-body">
							<p class="mb-1 text-black">Fees Collect</p>
							<h3 class="">250$</h3>
							<div class="progress mb-2 bg-secondary">
								<div class="progress-bar progress-animated bg-white" style="width: 30%"></div>
							</div>
							<small class="text-black">30% Increase in 30 Days</small>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="widget-stat card">
				<div class="card-body p-4">
					...
					<div class="progress mb-2">
						<div class="progress-bar progress-animated bg-primary-light" style="width: 80%"></div>
					</div>
		...
		<div class="col-xl-3  col-lg-6 col-sm-6">
			<div class="widget-stat card">
				<div class="card-body p-4">
					...
					<h3>245</h3>
					<div class="progress mb-2">
						<div class="progress-bar progress-animated bg-warning-light" style="width: 50%"></div>
					</div>
		...
		<div class="col-xl-3  col-lg-6 col-sm-6">
			<div class="widget-stat card">
				<div class="card-body p-4">
					...
					<h3>28</h3>
					<div class="progress mb-2">
						<div class="progress-bar progress-animated bg-primary-light" style="width: 76%"></div>
					</div>
					<small>76% Increase in 20 Days</small>
				</div>
			</div>
		...
		<div class="col-xl-3  col-lg-6 col-sm-6">
			<div class="widget-stat card">
				<div class="card-body p-4">
					...
					<h3>25160$</h3>
					<div class="progress mb-2">
						<div class="progress-bar progress-animated bg-success-light" style="width: 30%"></div>
					</div>
		...
		<div class="col-xl-12 col-lg-12 col-sm-12">
			<div class="row">
				...
				<div class="col-xl-3  col-lg-6 col-sm-6">
					<div class="widget-stat card bg-danger-light overflow-hidden">
		...
		<div class="col-xl-4 col-lg-6 col-sm-6">
			<div class="card active_users">
				<div class="card-header bg-primary-light border-0 pb-0">
		...
		<div class="col-xl-4 col-lg-12 col-sm-12">
			<div class="card overflow-hidden">
				<div class="text-center p-3 overlay-box " style="background-image: url({{ asset('images/big/img1.jpg')}});">
					...
					<h3 class="mt-3 mb-1">Deangelo Sena</h3>
				...
				<div class="card-footer border-0 mt-0">								
					<button class="btn btn-primary light btn-lg btn-block">
						...
						<table class="table verticle-middle table-responsive-md">
							...
							<tbody>
								<tr>
									...
									<td><span class="badge badge-rounded badge-primary light">Checkin</span></td>
									<td>$120</td>
									<td class="text-end">
								...
								<tr>
									...
									<td>Dr. Charles</td>
									<td>31 July 2020</td>
									<td><span class="badge badge-sm badge-rounded badge-warning light">Panding</span></td>
									<td>$540</td>
									<td class="text-end">
										<div class="dropdown custom-dropdown mb-0">
											<div class="btn sharp btn-primary light tp-btn" data-bs-toggle="dropdown">
								...
								<tr>
									...
									<td>Dr. Frederick</td>
									<td>30 July 2020</td>
									<td><span class="badge badge-sm badge-rounded badge-danger light">Canceled</span></td>
									<td>$301</td>
									<td class="text-end">
										<div class="dropdown custom-dropdown mb-0">
											<div class="btn sharp btn-primary light tp-btn" data-bs-toggle="dropdown">
								...
								<tr>
									...
									<td>Dr. Roman</td>
									<td>29 July 2020</td>
									<td><span class="badge badge-sm badge-rounded badge-success light">Checkin</span></td>
									<td>$099</td>
									<td class="text-end">
										<div class="dropdown custom-dropdown mb-0">
											<div class="btn sharp btn-primary light tp-btn" data-bs-toggle="dropdown">
		...
		<div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
			<div class="card text-white bg-primary-light">
				<ul class="list-group list-group-flush">
		...
		<div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
			<div class="card text-white bg-warning-light">
				<ul class="list-group list-group-flush">
		...
		<div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
			<div class="card">
				<div class="card-body text-center ai-icon  text-primary">
					...
					<a href="javascript:void();;" class="btn my-2 btn-primary light btn-lg px-4"><i class="fa fa-usd"></i> Earn Budges</a>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-4 col-lg-12 col-sm-12">
			<div class="card overflow-hidden">
				<div class="text-center p-5 overlay-box" style="background-image: url({{ asset('images/big/img5.jpg')}});">
					<img src="{{ asset('images/profile/profile.png')}}" width="100" class="img-fluid rounded-circle" alt="">
					<h3 class="mt-3 mb-0">Deangelo Sena</h3>
				</div>
				<div class="card-body">
					<div class="row text-center">
						...
						<div class="col-6">
							<div class="bgl-primary-light rounded p-3">
				...
				<div class="card-footer mt-0">								
					<button class="btn btn-primary light btn-lg btn-block">View Profile</button>		
				</div>
			</div>
		</div>
			...
			<div class="card bg-primary-light">
				<div class="card-body pb-0">
					<div class="row">
						<div class="col">
							<h5 class="">Power</h5>
							<span class="">2017.1.20</span>
						</div>
						<div class="col text-end">
							<h5 class=""><i class="fa fa-caret-up"></i> 260</h5>
							<span class="text-black">+12.5(2.8%)</span>
						</div>
					</div>
				</div>
		...
		<div class="col-xl-6 col-lg-6  col-sm-6">
			<div class="card bg-success-light overflow-hidden">
				<div class="card-body pb-0">
					<div class="row">
						<div class="col">
							<h5 class="">Power</h5>
