		...
		<div class="col-xl-6">
			<div class="card">
				<div class="card-body">
					...
					<button class="btn btn-primary light me-2" id="js-programmatic-enable">Enable</button>
					<button class="btn btn-primary light" id="js-programmatic-disable">Disable</button>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-4">
			<div class="card">
				<div class="card-body">
					...
					<button id="destroy-selector-trigger" class="btn btn-primary light">Destroy Select2</button>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-4">
			<div class="card">
				<div class="card-body">
					...
					<button id="dropdown-trigger-open" class="btn btn-primary light">Open Dropdown</button>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-4">
			<div class="card">
				<div class="card-body">
					...
					<button id="opening-dropdown-trigger" class="btn btn-primary light mb-2">Open
						Dropdown</button>
					<button id="closing-dropdown-trigger" class="btn btn-primary light mb-2">btn-close
						Dropdown</button>
					<div class="mt-4">
		...
		<div class="col-xl-6">
			<div class="card">
				<div class="card-body">
					...
					<button class="js-programmatic-set-val btn btn-primary light mb-2" aria-label="Set Select2 option">
						Set "California"
					</button>

					<button class="js-programmatic-open btn btn-primary light mb-2">
						Open
					</button>

					<button class="js-programmatic-btn-close btn btn-primary light mb-2">
						btn-close
					</button>

					<button class="js-programmatic-destroy btn btn-primary light mb-2">
						Destroy
					</button>

					<button class="js-programmatic-init btn btn-primary light mb-2">
						Re-initialize
					</button>
		...
		<div class="col-xl-6">
			<div class="card">
				<div class="card-body">
					...
					<button class="js-programmatic-multi-set-val btn btn-primary light mb-2" aria-label="Set Select2 option">
						Set to Hawaii and California
					</button>

					<button class="js-programmatic-multi-clear btn btn-primary light mb-2">
						Clear
					</button>
