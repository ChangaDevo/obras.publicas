			...
			<div class="card">
				...
				<div class="card-body">
					<div class="slider-disabled ">
						...
						<label>
							<input class="ms-2 form-check-input mt-0" type="checkbox" id="checkbox1">
							Disable slider
						</label>
					</div>
				</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="slider-disabled ">
						<div id="disable2"></div>
						<label>
							<input type="checkbox" class="form-check-input mt-0" id="checkbox2">
							Disable handle 1
						</label>
						<br>
						<label>
							<input type="checkbox" class="form-check-input mt-0" id="checkbox3">
							Disable handle 2
						</label>
					</div>
				</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="slider-update ">
						...
						<button class="update-button btn btn-info btn-sm mb-2" id="update-1">Set range [20, 50]</button>
						<button class="update-button btn btn-info btn-sm mb-2" id="update-2">Set range [10, 40]</button>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="getnset-slider">
						...
						<div class="logger mt-4">
							<button class="btn btn-info btn-sm" id="write-button">Set to 20</button>
							<button class="btn btn-info btn-sm" id="read-button">Read slider value</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="locked-slider">
						...
						<button class="btn btn-info btn-sm mt-4" id="lockbutton" style="float: right; margin: 20px 0 0;">Lock</button>
					</div>
				</div>
			</div>
		</div>
