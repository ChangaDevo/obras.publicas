    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
		@php
            ...
            if($page == 'dashboard_1' || $page == 'dashboard_2'){ $body_class = 'home-footer';}
            if($page == 'chat'){ $body_class = 'chat-height';}
            if($page == 'email_compose' || $page == 'email_inbox'){$body_class = 'inbox-height';}
        @endphp
		<!--**********************************
            Content body start
        ***********************************-->
		<div class="outer-body">
			<div class="inner-body">
                ...
                <!--**********************************
                    Footer start
                ***********************************-->
                @if(!in_array($page, array('chat','email_inbox','email_compose','email_read','post_details'), true ))
