        ...
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ url('index-4')}}">Dashboard 4</a></li>
                    <li><a href="{{ url('crm')}}">CRM</a></li>
                    <li><a href="{{ url('analytics')}}">Analytics</a></li>
                </ul>
            </li>
            <li><a href="{{ url('contacts')}}" class="" aria-expanded="false">
                <div class="menu-icon">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="{{ url('blog')}}" class="" aria-expanded="false">
                <div class="menu-icon">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li class="mini-dashboard">Users Manager</li>
                    <li><a href="{{ url('chat')}}">Chat</a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users Manager</a>
                        <ul aria-expanded="false">
                            
                            <li><a href="{{ url('app-profile-1')}}">Profile 1</a></li>
                            <li><a href="{{ url('app-profile-2')}}">Profile 2</a></li>
