        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item align-items-center header-border"><a href="{{ url('dashboard')}}" class="btn btn-primary">Dashboard</a></li>
                    <li class="nav-item ps-3">
                        <div class="header-profile2">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="header-info2 d-flex align-items-center">
                                    <div class="header-media">
                                        <img src="{{ asset('images/user.jpg')}}" class="avatar avatar-lg" alt="">
                                    </div>
                            ...
                            <div class=" profile-box">
                                <div class="products">
                                    <div class="border-img">
                                        <img src="{{ asset('images/user.jpg')}}" class="avatar " alt="">
                                    </div>	
                                    <div class="ms-3">
                                        <h6 class="mb-0">Thomas Fleming</h6>
                                        <span class="d-block mb-1">demo@gmail.com</span>
                                        <span class="badge border-0 rounded">Pro Mamber</span>
                                    </div>	
                                </div>
                                <div class="account-setting">
                                    <a href="{{ url('app-profile-2')}}" class="ai-icon">
                                    ...
                                    <a href="{{ url('app-profile-1')}}" class="ai-icon ">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="{{ url('page-login')}}" class="ai-icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
